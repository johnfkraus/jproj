...
# web application at http://thejournalismproject.pythonanywhere.com/
...
#import sys
#
#path = '/home/thejournalismproject/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/thejournalismproject/mysite/mysite/settings.py'
## and your manage.py is is at '/home/thejournalismproject/mysite/manage.py'
#path = '/home/thejournalismproject/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
#path = '/home/thejournalismproject/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
...
path = '/home/thejournalismproject/jproj'  # use your own username here
if path not in sys.path:
    sys.path.append(path)
